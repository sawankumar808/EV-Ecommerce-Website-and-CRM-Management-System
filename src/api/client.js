...
function normalizeApiPath(rawUrl) {
   ...
   * -> /public-products/5/
   *
   * Admin Products page doesn't use
   * this endpoint for detail.
   */

  if (
    /^\/products\/[^/]+\/?$/.test(url)
  ) {
    return `/public-products${url}`;
  }
  ...
  const aliases = [
    ...
    [
      "/vendor/customers",
      "/vendors/vendor/customers"
    ],

    [
      "/vendor/batteries",
      "/vendors/vendor/batteries"
    ],

    [
      "/vendor/scooters",
      "/vendors/vendor/scooters"
    ],
    ...
    [
      ...
      "/products/vendor-product-prices"
    ],
